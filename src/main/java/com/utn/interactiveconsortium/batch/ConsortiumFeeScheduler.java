...
@ConditionalOnProperty(name = "spring.batch.maintenance-fee.enabled", havingValue = "true", matchIfMissing = true)
public class ConsortiumFeeScheduler {
   ...
   @Scheduled(cron = "${spring.batch.maintenance-fee.cron:0 */5 * * * ?}")
